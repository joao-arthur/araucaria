...
pub fn compare_le(value: &OperandValue, operand: &OperandValue) -> Option<Result<(), ()>> {
...
mod tests {
    ...
    #[test]
    fn compare_le_usize_other_types() {
    ...
    #[test]
    fn compare_le_isize_other_types() {
    ...
    #[test]
    fn compare_le_bool_other_types() {
