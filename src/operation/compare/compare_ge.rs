...
pub fn compare_ge(value_a: &OperandValue, value_b: &OperandValue) -> Option<Result<(), ()>> {
...
mod test {
    ...
    #[test]
    fn test_compare_ge_u64_other_types() {
    ...
    #[test]
    fn test_compare_ge_i64_other_types() {
    ...
    #[test]
    fn test_compare_ge_f64_other_types() {
    ...
    #[test]
    fn test_compare_ge_usize_other_types() {
    ...
    #[test]
    fn test_compare_ge_isize_other_types() {
    ...
    #[test]
    fn test_compare_ge_bool_other_types() {
    ...
    #[test]
    fn test_compare_ge_str_other_types() {
