...
mod tests {
    ...
    #[test]
    fn compare_lt_usize_other_types() {
    ...
    #[test]
    fn compare_lt_isize_other_types() {
    ...
    #[test]
    fn compare_lt_bool_other_types() {
