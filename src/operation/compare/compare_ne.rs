...
mod tests {
    ...
    #[test]
    fn compare_ne_usize_other_types() {
    ...
    #[test]
    fn compare_ne_isize_other_types() {
    ...
    #[test]
    fn compare_ne_bool_other_types() {
