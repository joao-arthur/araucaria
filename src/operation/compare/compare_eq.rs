...
mod test {
    ...
    #[test]
    fn test_compare_eq_u64_other_types() {
    ...
    #[test]
    fn test_compare_eq_i64_other_types() {
    ...
    #[test]
    fn test_compare_eq_f64_other_types() {
    ...
    #[test]
    fn test_compare_eq_usize_other_types() {
    ...
    #[test]
    fn test_compare_eq_isize_other_types() {
    ...
    #[test]
    fn test_compare_eq_bool_other_types() {
    ...
    #[test]
    fn test_compare_eq_str_other_types() {
